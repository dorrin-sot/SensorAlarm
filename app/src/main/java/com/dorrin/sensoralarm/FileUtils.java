...
public class FileUtils {
                ...
                if (SDK_INT >= M) {
                    ...
                    if (!isEmpty(id)) {
                        ...
                        for (String contentUriPrefix : contentUriPrefixesToTry) {
                            try {
                                final Uri contentUri = withAppendedId(parse(contentUriPrefix), parseLong(id));
                    ...
                    try {
                        contentUri = withAppendedId(
                                parse("content://downloads/public_downloads"), parseLong(id));
    ...
    private static String getDriveFilePath(Uri uri, Context context) {
        ...
        int sizeIndex = returnCursor.getColumnIndex(SIZE);
        ...
        try {
            ...
            e("File Size", "Size " + file.length());
            inputStream.close();
            outputStream.close();
            e("File Path", "Path " + file.getPath());
            e("File Size", "Size " + file.length());
        } catch (Exception e) {
            e(FileUtils.class.getSimpleName(), e.getMessage());
        }
        return file.getPath();
    }
